...
public class ProductService {
     ...
     */
    public Product getProduct(long productId, String tokenId) throws ServiceException {
        Product product = productDao.select(productId, tokenId);
        if (product == null) {
    ...
    public Product updateProduct(long productId, Product newProduct) throws ServiceException {
     ...
     */
    @Transactional(rollbackFor = DataAccessException.class)
    public boolean addProduct(Product newProduct) throws ServiceException {
